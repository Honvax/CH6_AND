...
import com.alfrsms.and_ch6.utils.Utils
import com.alfrsms.and_ch6.worker.*
...
class ProfileViewModel @Inject constructor(private val dataStoreManager: DataStoreManager, application: Application) : ViewModel() {
    ...
    internal val outputsWorkInfo: LiveData<List<WorkInfo>> = workManager.getWorkInfosByTagLiveData(TAG_OUTPUT)
